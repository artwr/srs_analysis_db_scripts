USE [SRSAnalysis]
GO
/****** Object:  UserDefinedFunction [dbo].[is_in_d2]    Script Date: 05/16/2014 16:40:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[is_in_d2]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
