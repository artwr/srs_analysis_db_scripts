USE [SRSAnalysis]
GO
/****** Object:  StoredProcedure [dbo].[CreateTableCorrelations4R]    Script Date: 05/16/2014 16:40:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CreateTableCorrelations4R]') AND type in (N'P', N'PC'))
BEGIN
...
BEGIN
    ...
    */
    ...
    order by STATION_SEQ, CDATE, MDATE
